...
class SupervisedTrainer(BaseTrainer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.archive_name = kwargs.get("archive_name", None)
    ...
    def evaluate(self, epoch_num=None, keep_all=True):
        ...
        score_list = predictions.cpu().numpy()
        ...
        class_names = np.arange(probs.shape[1])  # TODO: temporary until I decide how to pass class names #[0 1 2 3]
